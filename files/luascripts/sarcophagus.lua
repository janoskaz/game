...
Console.WriteLine("\"All right\", you tell to yourself, that explains all of this.\nNow what will you do?")
...
if (answer == "1") then
	...
	if (times_opened == 2) then
		...
		Console.WriteLine("You carefully move the lid of the sarcophagus. Inside is laying mummy of Hrasekhmere with the things, which he loved the most on this world - papers and ink. Not a single piece of gold or anything like it. That's a dissapointment. One would expect some treasure, of mighty artefact, after all that troubles you had to go through to get here. Well, maybe NEXT TIME.")
		goto options
	end
else
...
config.explored_sarcophagus = true
